...
pres <- read_pptx() # create blank ppt

# Title Slide
pres <- pres %>% 
  add_slide(layout = "Title and Content", master = "Office Theme") %>% 
  ph_with_text(type = "title", str = "Reexamining Youth Voter Turnout") %>%
  ph_with_text(type = "body", str = "Do young candidates increase youth voter turnout?") %>%
